    ...
    <div id="header" class="header navbar-default">
      ...
      <div class="navbar-header">
        ...
        <router-link :to="{ name: 'dashboard' }" class="navbar-brand"
          ><span class="navbar-logo"></span> <b>CodeGea</b> CMS</router-link
        >
        <button
          type="button"
          class="navbar-toggle"
      ...
      <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown navbar-language" v-if="pageOptions.pageWithLanguageBar">
          <b-dropdown variant="link" menu-class="p-b-0">
            ...
            <b-dropdown-item href="javascript:;"
              ><span class="flag-icon flag-icon-us" title="us"></span> English</b-dropdown-item
            >
            <b-dropdown-item href="javascript:;"
              ><span class="flag-icon flag-icon-cn" title="cn"></span> Chinese</b-dropdown-item
            >
            <b-dropdown-item href="javascript:;"
              ><span class="flag-icon flag-icon-jp" title="jp"></span> Japanese</b-dropdown-item
            >
            <b-dropdown-item href="javascript:;"
              ><span class="flag-icon flag-icon-be" title="be"></span> Belgium</b-dropdown-item
            >
        ...
        <li class="dropdown navbar-user" v-if="user">
          <b-dropdown variant="link" ref="dropdown" menu-class="dropdown-menu-right">
            <template slot="button-content">
            ...
            <li>
              <router-link :to="{ name: 'settings.profile' }" class="dropdown-item" @click="onClose()">
